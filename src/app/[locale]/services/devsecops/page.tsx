    ...
    <div style={{ minHeight: '100vh', background: '#fff' }}>
      ...
      <section style={{
        ...
        <div style={{
          ...
          {[
            { title: tConsulting('infrastructure'), icon: '🏗️', href: `/${currentLocale}/services/infrastructure` },
            { title: tConsulting('resourcing'), icon: '👥', href: `/${currentLocale}/services/resourcing` },
