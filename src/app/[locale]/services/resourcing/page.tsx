    ...
    <div style={{ minHeight: '100vh', background: '#fff' }}>
      ...
      <section style={{
        ...
        <div style={{
          ...
          {[
            { title: tConsulting('consulting').replace(' Services', ''), icon: '📊', href: `/${currentLocale}/services/consulting` },
            { title: tConsulting('training'), icon: '🎓', href: `/${currentLocale}/services/training` },
